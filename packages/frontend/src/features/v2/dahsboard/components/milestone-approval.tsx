        ...
        <tbody>
          {props.milestones.map((mile) => (
            <tr key={mile.blockchainId}>
              ...
              <td className="w-1">
                <div className="flex flex-col">
                  ...
                  <div className="flex">
                    ...
                    <div className="grow justify-center hidden mt-5 @max-[358px]:flex">
                      <img
              ...
              <td className="font-bold text-right pr-5 @max-[730px]:hidden">
                {formatCurrency(formatUSDC(mile.amount ?? 0), "USD")}
              </td>
              <td className="w-1 align-top @max-[600px]:hidden">
                <div className="flex gap-4 px-2 @max-[625px]:flex-col">
                  <Button
                    onClick={() => onDeny(mile)}
                    label="Deny"
