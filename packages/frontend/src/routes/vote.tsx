...
function Bottom() {
  ...
  return (
    <div ref={ref} className="h-50">
      <div className="flex h-full relative before:bg-skgreen before:absolute before:inset-0 isolate before:-z-1 before:[clip-path:_ellipse(60%_100%_at_50%_100%)]">
        <div className="flex flex-col w-max gap-2 flex-wrap items-center mx-auto mb-10">
...
function RouteComponent() {
  return (
    <div className="grow flex flex-col relative h-[calc(100vh-162.4px)] overflow-hidden">
